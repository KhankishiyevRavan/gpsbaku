...
import UsersData from "./pages/Tables/UsersData";
import ContractForm from "./pages/Forms/ContractForm";
import UpdateContractForm from "./pages/Forms/UpdateContractForm";
...
import PaymentTable from "./pages/Forms/PaymentTable";
import PaymentForm from "./pages/Forms/PaymentFrom";
...
import CallTypeSelector from "./pages/Forms/Call/CallTypeSelector";
import NonSubscriberCallForm from "./pages/Forms/Call/NonSubscriberCallForm";
import SubscriberCallForm from "./pages/Forms/Call/SubscriberCallForm";
...
import EditPackageForm from "./pages/Forms/EditePackageForm";
      ...
      <Router>
        ...
        <Routes>
          ...
          >
            ...
            {/* gpsbaku.az Page */}
            <Route path="/list" element={<UsersData />} />
