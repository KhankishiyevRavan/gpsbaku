...
export default function EditUserDataForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const isAccountNameEmpty = !accountName?.trim();
    const ismeasurementSystemEmpty = !measurementSystem?.trim();
    ...
    if (isAccountNameEmpty)
      emptyErrors.accountName = "İstifadəçi adı qeyd edilməlidir";
    if (ismeasurementSystemEmpty)
      emptyErrors.measurementSystem = "İstifadəçi adı qeyd edilməlidir";
  ...
  const optionsMeasurementSystem = [
    { value: "kmp", label: "Kilometr" },
    { value: "mph", label: "Mil" },
  ];
  const handleSelectChangeMeasurementSystem = (value: string) => {
    console.log("Selected value:", value);
    setFormData({ ...formData, measurementSystem: value });
  };
  return (
    <ComponentCard title="">
        ...
        <div className="space-y-6 grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input
              ...
              placeholder="Hesab adı daxil edin"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <Select
              options={optionsMeasurementSystem}
              placeholder="Seçim edin"
              onChange={handleSelectChangeMeasurementSystem}
              className={
                errors.measurementSystem
                  ? "border-2 border-red-500 dark:border-red-500"
                  : "dark:bg-dark-900"
