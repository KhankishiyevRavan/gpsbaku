...
export const getRoleById = async (id: string): Promise<roleDataInterface> => {
  return axios
    .get(`${import.meta.env.VITE_API_URL}/roles/${id}`)
    .then((res) => res.data);
};
...
export const getRoleByName = async (
  ...
  return axios
    .get(`${import.meta.env.VITE_API_URL}/roles/name/${name}`)
    .then((res) => res.data);
};
...
export const updateRole = async (
  ...
  return axios
    .put(`${import.meta.env.VITE_API_URL}/roles/edit-role/${id}`, updatedData)
    .then((res) => res.data);
};
