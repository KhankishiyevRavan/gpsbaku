...
export default function Balance() {
  ...
  const handleClick = () => {
    ...
    if (localStorage.getItem("role") == "abuneci") {
      navigate("/balance");
    }
  };
  ...
  return (
    <div className="relative">
      <button
        className="relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full dropdown-toggle hover:text-gray-700 h-11 w-max hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white p-2 gap-2"
        onClick={handleClick}
      >
        <svg
          className="nav_item_wallet navButton_icon--RMuqr navButton_icon_start--OYwhM"
        ...
        >
          <g id="Apps_0">
            ...
            <path
              id="Vector_19_2"
              d="M13.0248 8.06845L5 10H18L14.5835 8.14974C14.2893 7.99037 13.5166 7.95007 13.0248 8.06845Z"
            ></path>
            <path
              id="Vector_19_Stroke_3"
              fillRule="evenodd"
              clipRule="evenodd"
            ...
            <path
              id="Vector_20_4"
              d="M16.6288 8.01309L5 9H19L17.8606 8.16193C17.6906 8.03689 17.1368 7.96998 16.6288 8.01309Z"
            ></path>
            <path
              id="Vector_20_Stroke_5"
              fillRule="evenodd"
              clipRule="evenodd"
