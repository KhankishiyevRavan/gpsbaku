...
exports.login = async (req, res) => {
  ...
  if (!isRecaptchaValid) {
    return res
      .status(403)
      .json({ message: "reCAPTCHA doğrulaması uğursuz oldu" });
  }

  // İndi istifadəçi yoxlanışı davam edir
...
exports.resetPassword = async (req, res) => {
  ...
  try {
    ...
    const html = `
      ...
      Sayt: <a href="https://www.gpsbaku.az" target="_blank"><strong>www.gpsbaku.az</strong></a>
      </p>
`;
